...
This branch is no longer active, however check out the version 2.0 rewrite maintained by "Yanick Rochon":https://github.com/yanickrochon/jquery.uix.multiselect.
